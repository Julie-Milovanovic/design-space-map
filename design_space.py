...
st.markdown("This graph represents new concepts generated by designers overtime. Connections represents design processes that connects two ideas. The design processes are generated using the Function Behavior Structure ontology.")
